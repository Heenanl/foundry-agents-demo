...
function ChatPage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const syncedParticipants = backendParticipantsList.map((p, index) => ({
          ...
          name: p.name,
          type: p.type,
          color: COLORS.participants[index % COLORS.participants.length]
        }));
  ...
  const handleAddParticipant = async () => {
    ...
    const newParticipant = {
      ...
      type: 'user',
      color: COLORS.participants[backendParticipants.length % COLORS.participants.length]
    };
    ...
    <div className="container">
      ...
      <div className="App">
        ...
        <header className="header">
          <h1>Echo Chat</h1>
          <button onClick={() => navigate('/form-checker')} className="nav-button-header">
            Form Checker →
          </button>
          <img 
            src="/geekster.png" 
      ...
      <div className="input-container">
        {/* Upload document button - navigates to form checker */}
